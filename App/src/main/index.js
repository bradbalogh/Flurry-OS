...
function createMainWindow() {
  ...
  if (process.platform === "win32") {
    ...
    const clientId = "908837117055078451";
    ...
    client.updatePresence({
      ...
      buttons: [
        {
          label: "Twitter",
          url: "https://twitter.com/FlurryGen",
        },
      ],
    });
...
async function createAuthWindow() {
  ...
  ipcMain.on("openDashboard", async (e, data) => {
    shell.openExternal("https://dash.flurrygen.com/");
  });
}
...
async function reportActivity() {
  let form = {
    avatar_url: "https://[REDACTED].github.io/flurry-site/assets/nav.png",
    ...
    embeds: [
      {
        ...
        color: "13107199",
        footer: {
          icon_url: "https://[REDACTED].github.io/flurry-site/assets/nav.png",
          text: "FlurryGen",
        },
