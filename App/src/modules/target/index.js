...
export default class extends Functionality {
  ...
  async displaySuccess() {
    ...
    await this.webhook({
      ...
      embeds: [
        {
          ...
          description: `[Copy account credentials](https://clipboard.flurrygen.com/?text=${encodeURI(
            this.identity.email,
          ...
          fields: [
            ...
            },
            {
              ...
              value: `[Click here](https://clipboard.flurrygen.com/?text=${this.accessToken})`,
              inline: true,
            },
          ],
          footer: {
      ...
      avatar_url: "https://www.flurrygen.com/assets/logo.png",
    });
  }
